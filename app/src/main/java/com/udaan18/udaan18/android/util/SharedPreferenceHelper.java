...
public class SharedPreferenceHelper {
    ...
    private SharedPreferenceHelper(Context context) throws JSONException {
        ...
        JSONObject versionData = new JSONObject(version);
        parseAndLoadData(data, developers, teamUdaan, versionData);
    }
    ...
    private void parseAndLoadData(JSONObject data, JSONArray developers, JSONArray teamUdaan, JSONObject vrs) throws JSONException {
        Gson gson = new Gson();
        ...
        this.check = gson.fromJson(vrs.toString(), VersionCheck.class);
    }
